export const VAULT_V2_ABI = [{
  ...
  "inputs": [
    ...
    { "internalType": "uint256", "name": "_allocBPS", "type": "uint256" },
  ],
  "name": "addStrategy",
  "outputs": [],
  "stateMutability": "nonpayable",
  ...
  "inputs": [{ "internalType": "int256", "name": "_roi", "type": "int256" }, {
    "internalType": "uint256",
    "name": "_repayment",
    "type": "uint256",
  }],
  ...
  "outputs": [
    ...
    { "internalType": "uint256", "name": "allocBPS", "type": "uint256" },
    { "internalType": "uint256", "name": "allocated", "type": "uint256" },
    { "internalType": "uint256", "name": "gains", "type": "uint256" },
